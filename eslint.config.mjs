...
// of six packages. So the framework-neutral half is imported from `@ploaness/config/eslint-core` and
...
export default compose(
  {
    ignores: [
      ...
      // Generated by packages/ploaness/build.ts from the shipped configs. All four of them: the two
      // core halves were absent here for as long as they were absent from the write denial, so a file
      // the build overwrites was being linted as though it were written by hand.
