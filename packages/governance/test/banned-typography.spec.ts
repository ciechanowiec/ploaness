...
const LEFT_QUOTE = String.fromCodePoint(0x201c)
const RIGHT_QUOTE = String.fromCodePoint(0x201d)
const LOW_QUOTE = String.fromCodePoint(0x201e)
...
describe('findTypographyViolations', () => {
  ...
  it('flags an em dash with a hyphen replacement at a 1-based position', () => {
    const result = findTypographyViolations(`ab${EM_DASH}cd`)
