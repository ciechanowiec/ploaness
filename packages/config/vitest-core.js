...
const PROJECT_SETUP_FILE = './vitest.setup.ts'
 ...
 */
export const PROPERTY_TEST_SEED = 1_734_000_000
...
const TEST_ORDER_SEED = 1_734_000_002
 ...
 */
export const harnessSetupFile = () => fileURLToPath(new URL('./vitest-setup.js', import.meta.url))
 ...
 */
export const projectSetupFiles = () =>
  existsSync(join(process.cwd(), PROJECT_SETUP_FILE)) ? [PROJECT_SETUP_FILE] : []
 ...
 */
export const DETERMINISTIC_SEQUENCE = Object.freeze({
