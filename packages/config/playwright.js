...
//
// Everything here is policy rather than preference. `forbidOnly` on CI is the end-to-end analogue of the
// focused-test ban ploaness already enforces for Vitest: a left-behind `test.only` would otherwise turn
// the suite into one green test. A single worker is not a performance choice either - every spec shares
